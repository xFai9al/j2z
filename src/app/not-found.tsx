...
const T = {
  en: {
    ...
    sub: "This link doesn't exist or may have been moved. Check the URL or head back home.",
  ...
  ar: {
    ...
    sub: 'هذا الرابط غير موجود أو ربما تم نقله. تحقق من الرابط أو عُد إلى الصفحة الرئيسية.',
    btn_home: 'العودة للرئيسية',
    btn_dashboard: 'الذهاب للوحة التحكم',
  },
}
...
.nf-lang:hover{background:#EFEAE0;}
...
.sub{font-size:15px;color:#6B6257;max-width:380px;line-height:1.6;margin-bottom:32px;}
      ...
      <body>
        <div className="nf-wrap" dir={dir}>
          ...
          <div className="actions">
            <Link className="btn-home" href="/">{t.btn_home}</Link>
